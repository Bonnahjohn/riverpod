...
export interface ApiFrenchFrench extends Schema.CollectionType {
  collectionName: 'frenches';
  info: {
    singularName: 'french';
    pluralName: 'frenches';
    displayName: 'french';
...
export interface ApiQuestionQuestion extends Schema.CollectionType {
  ...
  attributes: {
    MainQuestion: Attribute.Text;
    correct_answer: Attribute.String;
    incorrect_answer: Attribute.Text &
      Attribute.SetMinMaxLength<{
        minLength: 3;
      }>;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::french.french': ApiFrenchFrench;
      'api::me.me': ApiMeMe;
